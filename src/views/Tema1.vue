...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .col-lg-10.d-flex.flex-wrap.align-items-center.mb-5.mx-auto
      ...
      img.order-1.order-lg-2.mb-4.mb-lg-0.col-lg-6.mx-auto.mb-auto(src="@/assets/curso/temas/tema1/img-1.svg" style="max-width: 505px;" data-aos="fade-left")

    .col-lg-10.d-flex.flex-wrap.align-items-center.mb-5.mx-auto
      img.mb-4.mb-lg-0.col-lg-6.mx-auto.mb-auto(src="@/assets/curso/temas/tema1/img-2.svg" style="max-width: 505px;" data-aos="fade-right")
    ...
    .col-lg-10.d-flex.flex-wrap.align-items-center.mb-5.mx-auto
      .col-lg-6.pe-lg-3.order-2.order-lg-1(data-aos="fade-right")
        ...
        p Cuando se emprendían proyectos de desarrollo de software mucho más pequeños que exigían tiempos de respuesta cortos para la obtención de resultados, esta metodología se tornó completamente ineficiente pues se gastaba mucho tiempo y recursos en cada fase del proyecto y no se podían realizar cambios a los requisitos para mejorar el producto, por lo tanto empezaron a surgir nuevos métodos más ágiles con un enfoque iterativo es decir por bloques de tareas para llevar a cabo los requisitos de los usuarios teniendo en cuenta que estos pueden cambiar durante todo el proceso de desarrollo.
      img.order-1.order-lg-2.mb-4.mb-lg-0.col-lg-6.mx-auto.mb-auto(src="@/assets/curso/temas/tema1/img-3.svg" style="max-width: 505px;" data-aos="fade-left")
    ...
    .d-flex.flex-wrap.mb-5
      ...
      .col-lg-6(data-aos="fade-left")
        ...
        p.mb-5.ps-lg-4 Estas metodologías no solamente se utilizan en el sector de las TIC para el desarrollo de software y sistemas de información, también se pueden aplicar a cualquier sector productivo, proyecto que se quiera emprender o entorno donde se produzcan cambios de forma frecuente.
          br
          br
    ...
    SlyderF.mb-5(columnas="col-12 col-lg-6 col-xl-4")
      .tarjeta.p-4(style="background-color: #C0EBF6")
        .row.justify-content-center.mb-3
          .col-8
            img.mx-auto(src='@/assets/curso/temas/tema1/sl-1.png' style="margin-top: -6rem; max-width: 136px" data-aos="fade-left")
      ...
      .tarjeta.p-4(style="background-color: #C0EBF6")
        .row.justify-content-center.mb-3
          .col-8
            img.mx-auto(src='@/assets/curso/temas/tema1/sl-2.png' style="margin-top: -6rem; max-width: 136px" data-aos="fade-left")
      ...
      .tarjeta.p-4(style="background-color: #C0EBF6")
        .row.justify-content-center.mb-3
          .col-8
            img.mx-auto(src='@/assets/curso/temas/tema1/sl-3.png' style="margin-top: -6rem; max-width: 136px" data-aos="fade-left")
      ...
      .tarjeta.p-4(style="background-color: #C0EBF6")
        .row.justify-content-center.mb-3
          .col-8
            img.mx-auto(src='@/assets/curso/temas/tema1/sl-4.png' style="margin-top: -6rem; max-width: 136px" data-aos="fade-left")
